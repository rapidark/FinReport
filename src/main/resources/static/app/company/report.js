                    ...
                    $.each(this, function (i) {
                        ...
                        if (key == 'report' && this.json[0].indexOf('12-31') == -1) {
                            ...
                            if (i == 0 && years instanceof Array && years[0] != this.json[i]) {
                                ...
                                if (customReport.containsColumnName('上一年' + columName)) {
                                    if (customReport.getColumnData('上一年' + columName)[0] != this.json[4]) {
                                        customReport.getColumnData('上一年' + columName).unshift(this.json[4]);
                                    }
                                }
                            }
                        }
